...
func (sed *SubEventDetailRepository) Create(ctx context.Context, detail *entity.SubEventDetail) error {
	...
	if _, err := sed.db.NewInsert().Model(detail).Exec(ctx); err != nil {
		return err
	}
	return nil
}
